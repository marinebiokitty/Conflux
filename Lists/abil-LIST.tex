...
\NEW{Abil}{\aWorkConduit}{
  ...
  \s\MYeffect	{This ability allows you to work the Conduit Machine. Refer to your ``\gConduitCover{}'' greensheet for details on how to use the this machine to locate the point of closest contact (this greensheet is a duplicate of the sheet attached to the machine and is provided for your reference pre-game). Refer to your ``\gConduit{}'' greensheet for details on how to use the machine to open the conduit.
...
This information is transferable. You may freely tell other characters how to work the machine and they will gain this ability as well. This information is also extractable. You may be compelled under enslavement to reveal it. If you tell someone how to use the machine, direct them to acquire a copy of this ability from the $\Omega$ Packet in -013.}
  \s\MYgreens{\gConduit{} \gConduitCover{}}
}
...
%%Conduit sealing/unsealing abilities. No longer relevant
\NEW{Abil}{\aDrawBlood}{
  \s\MYname	{Draw Blood}
...
\NEW{Abil}{\aMakeWhite}{
  \s\MYname	{Create Amaranth}
  \s\MYtext	{I am quietly meditating.}
  \s\MYeffect	{Being a quintessence elemental, you know how to create \iWhiteQ{}, but it requires you to expend a part of your essence. If you would like to do so, find a quiet location conducive to meditating (the place where the water elementals would have met may work), destroy one of your \iQEssence{}, and take one \iWhiteQ{} from that location. {\bf You may use this ability this once every 30 minutes.}}
}
...
\NEW{Abil}{\aAirTeleport}{
  ...
  \s\MYeffect	{Once per hour, you may go Not Here for up to five minutes, and return to game in any area you could normally access. You may use this immediately, if available, in response to any ability that would otherwise kill or incapacitate you.}
%Belongs to Mistral
}
...
\NEW{Abil}{\aCalmDown}{
  ...
  \s\MYeffect  {Use your training as a negotiator to defuse an escalating situation.  No one who can hear you may take violent actions for 5 minutes. This ability has a one hour cool down before it can be used a second time. (x2)}
  %Avatar
}
...
\NEW{Abil}{\aStudyHistory}{
  ...
  \s\MYeffect  {(3 uses per game) By invoking the memory of your great-grandfather's accident, you can prevent all listeners from performing or advocating irresponsible science for 5 minutes.}
  %Granddaughter
}
...
\NEW{Abil}{\aDontMindMe}{
  ...
  \s\MYtext  {I play up my low rank to look very small and inconspicuous (but still visible). You forget I'm even around.}
